...
At this point we have discretized the energy and angle variables using the multigroup and \$P\(_{\text{N}}\)\$/\(S_N\) methods, respectively.  The only phase variable that has not been discretized is the spatial variable.
\end{document}
...
*Mass:* Masses on the nuclear scale at typically expressed in units of /atomic mass units/ (u), defined so that the mass of a neutron atom of $\leftidx{^12_6}{C}{}$ is exactly 12 u.
